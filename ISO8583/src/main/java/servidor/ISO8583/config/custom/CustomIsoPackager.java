package servidor.ISO8583.config.custom;
...
public class CustomIsoPackager extends ISOBasePackager {
    ...
    protected ISOFieldPackager[] fld = {
     ...
     new IFA_NUMERIC(6, "SYSTEM TRACE AUDIT NUMBER (STAN)"),
     ...
     new IFA_AMOUNT(9, "AMOUNT, SETTLEMENT PROCESSING FEE"), new IFA_LLNUM(11, "ACQUIRING INSTITUTION IDENT CODE"),
     ...
     new IFA_LLLCHAR(999, "RESERVED PRIVATE"),
     new IFA_LLLCHAR(999, "RESERVED PRIVATE"),
     new IF_CHAR(8, "MESSAGE AUTHENTICATION CODE FIELD")
    };
